...
<header class="container-fluid pt-3">
    <h1 class="color-primary header1 mb-3 font-weight-700">List Grup</h1>
</header>
...
@push('css')
<link rel="stylesheet" href="{{ asset('back_assets/dist/css/pages/system/grup/index.css') }}">
@endpush
...
<script>
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            ...
            "url": "{{ route('api.back.system.grup') }}",
            "dataType": "json",
            "type": "POST"
        },
        "columns": [
