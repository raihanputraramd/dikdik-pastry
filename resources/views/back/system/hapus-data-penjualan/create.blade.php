<section class="p-3">
    <form id="form-validation" action="{{ route('back.system.hapus-data-penjualan.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="form-group mb-12">
            <label for="">Hapus Data Penjualan Sebelum</label>
