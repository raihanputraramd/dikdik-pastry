<section class="p-3">
    <form id="form-validation" class="row justify-content-center" action="{{ route('back.master-data.supplier.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="col-md-12 mb-12">
            <div class="form-group">
                ...
                <input type="number" class="form-control form-control-sm br12px" name="no_hp" id="no_hp">
            </div>
        </div>
        <div class="col-md-12 mb-12">
            <div class="form-group">
                <label for="no_telepon">No. Telp</label>
                <input type="number" class="form-control form-control-sm br12px" name="no_telepon" id="no_telepon">
            </div>
        </div>
        <div class="col-md-12 mb-12">
            <div class="form-group">
