...
<header class="container-fluid pt-3">
    <h1 class="color-primary header1 mb-3 font-weight-700">List Supplier</h1>
</header>
        ...
        <div class="col-lg-12 mb-2">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div>
                    ...
                    <a class="text-decoration-none" href="{{ route('back.master-data.supplier.export') }}" target="_blank">
                        <button class="btn btn-custom green px-3 ml-3">
                            <i class="fas fa-file-excel mr-2"></i>
                            File Excel
                        </button>
                    </a>
                    <a class="text-decoration-none" href="{{ route('back.master-data.supplier.pdf') }}" target="_blank">
...
@push('css')
<link rel="stylesheet" href="{{ asset('back_assets/dist/css/pages/master-data/supplier/index.css') }}">
@endpush
...
<script>
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            ...
            "url": "{{ route('api.back.master-data.supplier') }}",
            "dataType": "json",
            "type": "POST"
        },
        "columns": [
