...
<header class="container-fluid pt-3">
    <h1 class="color-primary header1 mb-3 font-weight-700">Laporan Saldo Bank</h1>
</header>
    ...
    <div class="row">
        ...
        <div class="col-lg-12 mb-2">
            ...
            <div class="d-flex justify-content-end">
                ...
                <form id="export-excel" target="_blank" action="{{ route('back.laporan.laporan-saldo-bank.export') }}">
                ...
                <form id="page-pdf" action="{{ route('back.laporan.laporan-saldo-bank.pdf') }}" method="GET" target="_blank">
                    <input type="hidden" name="startDate" class="form-control" id="startDate">
                    <input type="hidden" name="endDate" class="form-control" id="endDate">
...
@push('css')
<link rel="stylesheet" href="{{ asset('back_assets/dist/css/pages/laporan/laporan-saldo-bank/index.css') }}">
@endpush
...
<script>
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            ...
            "url": "{{ route('api.back.laporan.bank-transfer') }}",
            "dataType": "json",
            "type": "POST",
            "data": function(d) {
                d.startDate = start;
    ...
    function getTotal(tanggal = "hari") {
        $.ajax({
            headers: {'X-CSRF-TOKEN': '{{ csrf_token() }}'},
            url: "{{ route('api.back.laporan.bank-transfer.total') }}",
            dataType: "json",
            type: "POST",
            data: {
                "startDate": start,
