...
<header class="container-fluid pt-3">
    <h1 class="color-primary header1 mb-3 font-weight-700">Laporan Pembelian</h1>
</header>
    ...
    <div class="row">
        ...
        <div class="col-lg-12 mb-2">
            ...
            <div class="d-flex justify-content-end">
                ...
                <form action="{{ route('back.laporan.pembelian.export') }}" method="GET" target="_blank">
                ...
                <form id="page-pdf" action="{{ route('back.laporan.pembelian.pdf') }}" method="GET" target="_blank">
...
@push('css')
<link rel="stylesheet" href="{{ asset('back_assets/dist/css/pages/laporan/laporan-pembelian/index.css') }}">
@endpush
...
<script>
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            ...
            "url": "{{ route('api.back.laporan.pembelian') }}",
            "dataType": "json",
            "type": "POST",
            "data": function(d) {
                d.startDate = start;
    ...
    function getTotal(tanggal = "hari") {
        $.ajax({
            headers: {'X-CSRF-TOKEN': '{{ csrf_token() }}'},
            url: "{{ route('api.back.laporan.pembelian.total') }}",
            dataType: "json",
            type: "POST",
            data: {
                "startDate": start,
