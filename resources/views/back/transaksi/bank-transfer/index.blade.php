...
<header class="container-fluid pt-3">
    <h1 class="color-primary header1 mb-3 font-weight-700">List Bank Transfer</h1>
</header>
        ...
        <div class="col-lg-12 mb-2">
            ...
            <div class="d-flex justify-content-between">
                <div class="input-group form-group mr-5 search-button-input">
                    <input type="text" class="form-control form-control-sm border-right-0" placeholder="Cari Keterangan" id="external_filter">
                ...
                <div>
                    ...
                    <a class="text-decoration-none" id="export-excel" target="_blank" href="{{ route('back.transaksi.bank-transfer.export') }}">
                        <button class="btn btn-custom green px-3 ml-3">
                            <i class="fas fa-file-excel mr-2"></i>
                            File Excel
                        </button>
                    </a>
                    <a class="text-decoration-none" target="_blank" href="{{ route('back.transaksi.bank-transfer.pdf') }}">
                        <button class="btn btn-custom green px-3 ml-3">
...
@push('css')
<link rel="stylesheet" href="{{ asset('back_assets/dist/css/pages/transaksi/input-bank-transfer/index.css') }}">
@endpush
...
<script>
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            ...
            "url":  "{{ route('api.back.transaksi.bank-transfer') }}",
            "dataType": "json",
            "type": "POST"
        },
        "columns": [
