...
<header class="container-fluid pt-3">
    <h1 class="color-primary header1 mb-3 font-weight-700">List Pelunasan Hutang</h1>
</header>
    ...
    <div class="row">
        ...
        <div class="col-lg-12 mb-2">
            ...
            <div class="d-flex justify-content-end">
                ...
                <form id="export-excel" target="_blank" action="{{ route('back.transaksi.bayar-hutang.export') }}">
                ...
                <form id="page-pdf" action="{{ route('back.transaksi.bayar-hutang.print') }}" method="GET" target="_blank">
                    <input type="hidden" name="startDate" class="form-control" id="startDate">
                    <input type="hidden" name="endDate" class="form-control" id="endDate">
...
@push('css')
<link rel="stylesheet" href="{{ asset('back_assets/dist/css/pages/transaksi/bayar-hutang/create.css') }}">
@endpush
...
<script>
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            ...
            "url": "{{ route('api.back.transaksi.bayar-hutang') }}",
            "dataType": "json",
            "type": "POST",
            "data": function(d) {
                d.startDate = start;
    ...
    function getTotal(tanggal = "hari") {
        $.ajax({
            headers: {'X-CSRF-TOKEN': '{{ csrf_token() }}'},
            url: "{{ route('api.back.transaksi.bayar-hutang.total') }}",
            dataType: "json",
            type: "POST",
            data: {
                "startDate": start,
